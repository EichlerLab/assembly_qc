...
fasta_set_files = snakemake.input
...
def get_contig_stats(fai_files):
    ...
    over_100k_bases_gbp = "{:,.3f}".format(over_100k_bases/1000000000.000)
    n50_mbp = "{:,.3f}".format(n50/1000000)
    l50_mbp = "{:,.3f}".format(l50/1000000)
    largest_size_mbp = "{:,.3f}".format(largest_size/1000000)
    aun_mbp = "{:,.3f}".format(aun/1000000)
